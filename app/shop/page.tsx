...
function page() {
  return (
    <section className='flex flex-col min-h-screen justify-between items-center w-full'>
      <Header />
      <div className="w-full h-[316px] bg-cover bg-center" style={{ backgroundImage: "url('/bg-shop.png')" }}>
        {/* top div */}
        <div className="flex items-center justify-center h-full">
          <div className="text-center p-6">
            <Image src="/logo.png" alt="Image" width={77} height={77} className='ml-4'/>
        ...
        <div className='mt-4 hidden md:block'>
          <Image src="/Group 63.png" alt="Image" width={1500} height={500} />
        </div>
      </div>
